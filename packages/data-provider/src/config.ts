...
export const billingSchema = z.object({
  enabled: z.boolean().optional().default(false),
  lemonSqueezy: lemonSqueezyConfigSchema.optional(),
  paypal: paypalConfigSchema.optional(),
});

export type TLemonSqueezyConfig = z.infer<typeof lemonSqueezyConfigSchema>;
export type TPayPalConfig = z.infer<typeof paypalConfigSchema>;
export type TBillingConfig = z.infer<typeof billingSchema>;
