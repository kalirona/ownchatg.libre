...
import { createSubscriptionPlanModel } from './subscriptionPlan';
import { createCreditPackModel } from './creditPack';
import { createUserSubscriptionModel } from './userSubscription';
import { createPaymentTransactionModel } from './paymentTransaction';
import { createWebhookEventModel } from './webhookEvent';
...
export function createModels(mongoose: typeof import('mongoose')): {
  ...
  SubscriptionPlan: ReturnType<typeof createSubscriptionPlanModel>;
  CreditPack: ReturnType<typeof createCreditPackModel>;
  UserSubscription: ReturnType<typeof createUserSubscriptionModel>;
  PaymentTransaction: ReturnType<typeof createPaymentTransactionModel>;
  ...
  return {
    ...
    SubscriptionPlan: createSubscriptionPlanModel(mongoose),
    CreditPack: createCreditPackModel(mongoose),
    UserSubscription: createUserSubscriptionModel(mongoose),
    PaymentTransaction: createPaymentTransactionModel(mongoose),
