...
export const useUpdateUserProfileMutation = (
  options?: t.MutationOptions<t.TUser, t.TUpdateUserProfile>,
): UseMutationResult<t.TUser, unknown, t.TUpdateUserProfile, unknown> => {
  return useMutation([MutationKeys.userProfileUpdate], {
    mutationFn: (variables: t.TUpdateUserProfile) => dataService.updateUserProfile(variables),
    ...(options || {}),
  });
};
